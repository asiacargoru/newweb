            ...
            <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-lg">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-6">
                <div className="space-y-2">
                  ...
                  <Select required>
                    ...
                    <SelectContent>
                      <SelectItem value="sea">Морская доставка</SelectItem>
                      <SelectItem value="air">Авиадоставка</SelectItem>
                      <SelectItem value="rail">Ж/Д доставка</SelectItem>
                      <SelectItem value="auto">Автодоставка</SelectItem>
                      <SelectItem value="unsure">Не уверен, нужна консультация</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="cargo">Тип груза *</Label>
                  <Input id="cargo" placeholder="Электроника, мебель, одежда..." required />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-3 gap-6 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="volume" type="number" placeholder="10" />
                </div>
                <div className="space-y-2">
